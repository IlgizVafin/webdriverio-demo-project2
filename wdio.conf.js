...
const tagProcessor = require('./src/tagProcessor');

const argv = minimist(process.argv);
const errorShotsPath = './errorShots';

exports.config = {
    host: argv.seleniumhost || '127.0.0.1',
    port: 4444,
    path: '/wd/hub',
    //
    // ==================
    ...
    capabilities: [{
        ...
        browserName: argv.browserName || 'chrome',
    }],
    //
    // ===================
    // Test Configurations
    ...
    // screenshotPath: errorShotsPath,
    //
    // Set a base URL in order to shorten url command calls. If your url
    // parameter starts with "/", then the base url gets prepended.
    baseUrl: 'http://localhost.ru/',
    //
    ...
    cucumberOpts: {
        ...
        // steps
        tags: tagProcessor(process.argv),
    ...
    afterStep: function (stepResult) {
        if (stepResult.getStatus() === 'failed') {
            const screenshotPath = `${errorShotsPath}/${uuid.v4()}-attachment.png`;
